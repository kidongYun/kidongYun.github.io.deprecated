...
> 슈퍼컴퓨터 환경에서 Data Migration와 Roofline 성능분석 모델을 활용해 Computing Performance를 향상시키는 연구를 진행했습니다. [자세히 보기](/knights-landing-study/){: target="_blank"}

<img src="/workspace/portfolio/res/paper.png" style="width:80%;"/> 

### __WKU (원광대 앱정보서비스)__

> 기존의 원광대 정보서비스는 오직 데스크탑 기준의 웹서비스만 제공했기에, 항상 불편함을 겪는 원광대 학생들의 편의를 위해 모바일에 UI가 최적화된 어플리케이션을 개발했습니다. [자세히 보기](/wonkwang-university-application/){: target="_blank"}

<img src="/workspace/portfolio/res/logo.jpg" style="width:80%;"/>

### __Yong Portfolio (디자이너 포트폴리오)__

> 디자이너 포트폴리오 전시를 위한 Static Page 입니다. [자세히 보기](/yong-portfolio/){: target="_blank"}

<img src="/workspace/portfolio/res/home.jpg" style="width:80%;"/>

### __Ecguide (공과대학 안내 시스템)__

> 원광대학교 공과대학이 낯선 분을 위해 키오스크 시스템과 모바일 기기를 활용하여 위치 안내 서비스를 제공합니다. [자세히 보기](/guide-system-for-engineering-college/){: target="_blank"}

<img src="/workspace/portfolio/res/ecguide.jpg" style="width:80%;"/>

### __DIP__

> Android Studio이나 Xcode의 Storyboard 처럼 웹디자인 코드를 Drag and Drop형태로 구현하기 위한 프로젝트입니다. [자세히 보기](/design-in-programming/){: target="_blank"}

<img src="/workspace/portfolio/res/dip.png" style="width:80%;"/>

### __원그릇 (원광대 맛집 어플리케이션)__

> 원광대학교 인근 맛집 정보를 공유하기 위한 소셜 커뮤니티 어플리케이션입니다. [자세히 보기](/wonkwang-restaurant-social-application/){: target="_blank"}

<img src="/workspace/portfolio/res/onebowl.png" style="width:90%;"/>

<!-- ### __LOCAT (위치 기반 소셜 커뮤니티 어플리케이션)__

> 위치를 기반으로하여 유저 간 소셜 커뮤니티를 형성하기 위한 앱입니다. [자세히 보기](/social-service-based-location/){: target="_blank"}
...
> 대학생활 중 학과동아리 아티니어를 창설하였는데, 이 동아리 아티니어 활동을 위한 홈페이지 구축하였습니다. [자세히 보기](/artineer/){: target="_blank"}
...
<img src="/workspace/portfolio/res/portfolio.jpg" style="width:50%;"/>
...
<img src="/workspace/portfolio/res/capstone.jpg" style="width:40%;"/>
